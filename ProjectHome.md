If you have some experience with managing disks with overlapping contents, like mirrors or backups, you probably use something like rsync or unison to compare these.
