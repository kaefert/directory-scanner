...
import com.googlecode.directory_scanner.directory_scanner.Worker.ReportMatch;
...
public class GUI {
    ...
    private JLabel lblPath1, lblPath2, lblDate;
    ...
    private JRadioButtonMenuItem sortNot, sortSize, sortCount, reportAll, 
    	reportPath1, report1stPath1, reportNotPath1, reportAllBut1stPath1, 
...
//	frmDirectoryScanner.setShape(new Polygon(new int[]{0,300,600,300,0}, new int[]{300,600,300,0,300}, 5));
...
//	});
//	
//	JButton btnSetDirectorySkipLimit = new JButton("Set Directory-skip limit");
...
//		    logger.error("what you entered in the date filed differed from my format (look at startup example value)", e1);
//		}
//	    }
//	});
//
...
//	});
//	
//	JButton btnDuplicatesOutside = new JButton("Files of Path1 with Duplicates");
...
//	northPanel.add(buttonPanel);
	...
	this.txtrFileList = new JTextArea("not yet implemented. sorry. if you need it, tell me.");
...
//		logger.info("txtDate keyPressed!" + e);
	...
	reportMenu.add(new AbstractAction("Duplicates in Path2") {
		...
		new Thread(new Runnable() {
		    @Override
		    public void run() {
			worker.findDuplicates(txtPath2.getText(), txtPath2.getText(), false);
		    }
		}).start();
	    }
	});
    ...
    private void doReport(HashSet<ReportMatch> findDuplicates) {
